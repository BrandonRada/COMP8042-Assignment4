...
public class SeparateChainingHashTable<AnyType>
{
    ...
    // Updated insert with collision counting
    /**
    ...
    public void insert( AnyType x )
    {
        ...
        // collisions = current bucket size
        int bucketSize = whichList.size();
    ...
    // Added helper methods for assignment metrics
    ...
    public static void main( String [ ] args )
    {
        ...
        System.out.println("Total collisions: " + H.getTotalCollisions());
        System.out.println("Max collisions: " + H.getMaxCollisions());
        System.out.println("Empty slots: " + H.getEmptySlots());
