...
public class QuadraticProbingHashTable<AnyType>
{
    ...
    private int findPos( AnyType x )
    {
        ...
        totalCollisions += collisionsThisSearch;
        if( collisionsThisSearch > maxCollisions )
            maxCollisions = collisionsThisSearch;
